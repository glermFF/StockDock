...
public class WalletConverter {
    ...
    public static WalletDomain toWalletDomain(UpdateWalletDTO updateWalletDTO){
        return WalletDomain.builder().id(updateWalletDTO.getId()).walletName(updateWalletDTO.getWalletName()).type(updateWalletDTO.getType()).build();
    }
